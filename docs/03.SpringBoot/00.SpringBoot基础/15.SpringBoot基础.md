...
![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/spring-start.png)
...
#### 1.4.5 常用条件注解
![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/condition.png)
...
**（2）热部署需要配置自动编译**
![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/boot-profile2.png)
快捷键ctrl + alt + shift + /   选择Register
勾选下面两个
![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/boot-profile.png)
...
![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/boot-autoconfig.png)
