...
```
![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/trace4.png)
...
![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/watch-exception.png)

2）正常输出

![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/watch.png)

3）调整输出遍历深度，观察参数的属性值，当前对象中的属性

![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/static-map.png)
...
![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/watch-x.png)
...
![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/montor.png)
...
![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/stack.png)
...
![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/jvm.png)
...
```
![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/heapdump.png)
...
logger
```
![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/logger.png)

2) 修改日志级别
```shell
logger --name com.fire.arthas.demo --level debug
```
![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/logger2.png)

再次请求，控制台输出了日志信息

![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/logger3.png)
...
```
![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/sc.png)
...
![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/sm.png)
...
![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/jad.png)
...
**用法**
```shell
retransform com.fire.arthas.demo.web.ArthasTestController.class
```
...
```
![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/retransform.png)
...
**用法**
```shell
redefine com.fire.arthas.demo.web.ArthasTestController.class
```
**案例**
...
![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/profiler.png)
