...
![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/二叉树.png)
...
![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/2.png)
...
![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/b树.png)

**加强版多路平衡查找树（B+Tree）**

加强版的多路平衡二叉树：叶子节点存储的具体的记录，物理数据和索引都是存储在B+树中
![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/b+树.png)

1. 关键字数=dgree
2. 内节点不存储数据
3. 叶子节点有双向指针

![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/b-tree.png)

![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/6.png)
...
![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/7.png)
...
![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/8.png)

![](https://cdn.jsdelivr.net/gh/FireHH/github_img_repository/arthas/9.png)
